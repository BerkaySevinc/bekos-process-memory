...
namespace Bekos.ProcessMemory;


public class MemoryManipulator : IDisposable
{
    ...
    public MemoryManipulator(int processId) : this(Process.GetProcessById(processId)) { }
    ...
    public MemoryManipulator() : this(Process.GetCurrentProcess()) { }
